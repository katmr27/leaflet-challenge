...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function (data) {
  ...
  function styleInfo(feature) {
    return {
      opacity: 1,
      fillOpacity: 1,
      fillColor: getColor(feature.properties.mag, feature.geometry.coordinates[2]),
      color: "#000000",
  ...
  function getRadius(magnitude) {
    if (magnitude === 0) return 1;  // To ensure earthquakes with magnitude 0 have a minimum radius
  return magnitude * 4;
  }
